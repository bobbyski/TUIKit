...
Phase 8 · Demo & Polish               ██████████████████░░░░░░░░   70%  🔄 Demo refactored into per-window files; window state (8.9–8.12) done; Turbo theme 8.5/8.13/8.14/8.15 + accelerators (8.6) + pill buttons (8.8) + multi-click (8.16) done; 8.7 border-embedded scrollbars pending
